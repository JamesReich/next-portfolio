                    ...
                    <div className="w-full lg:w-1/2 border border-black dark:border-white rounded p-5 m-2 self-center lg:self-start animate-fade-in-right">
                        <div>
                            ...
                            <div>
                                ...
                                <Image onClick={() => setIsStanHulseOpen(true)} className="mt-5 rounded cursor-pointer" src="/images/projects/stansite.webp" alt="A screenshot of stan hulse law dot com" width={1920} height={1080} />
                            </div>
                            <footer>
                            </footer>
                        </div>
